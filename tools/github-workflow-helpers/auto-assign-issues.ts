...
const TEAM_ASSIGNMENTS: { [label: string]: { [jobRole: string]: string } } = {
	"product:agents": { em: "whoiskatrin", pm: "mikenomitch" },
	"product:analytics-engine": {},
	api: { em: "dcartertwo", pm: "korinne" },
	auth: { em: "dcartertwo", pm: "korinne" },
	"feature:auto-provisioning": { em: "lrapoport-cf", pm: "mattietk" },
	"package:c3": { em: "lrapoport-cf", pm: "mattietk" },
	"product:constellation": {},
	"product:containers": { em: "th0m", pm: "mikenomitch" },
	"product:d1": { em: "joshthoward", pm: "vy-ton" },
	documentation: {},
	"product:durable-objects": { em: "joshthoward", pm: "vy-ton" },
	"product:email": { pm: "thomasgauvin" },
	"product:hyperdrive": { em: "sejoker", pm: "thomasgauvin" },
	"package:kv-asset-handler": { em: "lrapoport-cf", pm: "mattietk" },
	...
	"feature:observability": { em: "boristane", pm: "nevikashah" },
	opennext: { em: "lrapoport-cf", pm: "mattietk", tl: "vicb" },
	"product:pages": { em: "dcartertwo", pm: "irvinebroque" },
	"product:pipelines": {},
	"feature:playground-worker": { em: "lrapoport-cf", pm: "mattietk" },
	python: { em: "danlapid", pm: "mikenomitch" },
	"product:queues": {},
	"product:r2": { em: "annibread", pm: "aninibread" },
	"feature:remote-bindings": { em: "lrapoport-cf", pm: "mattietk" },
	...
	"feature:types-ai": { em: "jkipp-cloudflare" },
	"package:unenv": { em: "lrapoport-cf", pm: "mattietk" },
	"product:vectorize": { em: "sejoker", pm: "jonesphillip" },
	"package:vite-plugin": { em: "lrapoport-cf", pm: "mattietk" },
	"package:vitest": { em: "lrapoport-cf", pm: "mattietk" },
	"product:vpc": { em: "efalcao", pm: "thomasgauvin" },
	"feature:workers-assets": { em: "dcartertwo", pm: "irvinebroque" },
	"product:workers-ai": { em: "jkipp-cloudflare" },
	"feature:workers-builds": {
		director: "fredkschott",
		pm: "yomna-shousha",
		em: "ericclemmons",
	},
	"product:workflows": { em: "bruxodasilva", pm: "jonesphillip" },
	"package:wrangler": { em: "lrapoport-cf", pm: "mattietk" },
};

...
Updated: wrangler no longer sets a default value for max message retention if setting was not explicitly provided to wrangler, max retention period is now documented as 86400 seconds for free tier queues and 1209600 seconds for paid tier queues which fixes the issue of the default value of 365400 seconds max message retention being longer than the max allowed retention period for free tier users, wrangler also no longer sets a default value of 0 seconds for delivery delay if setting was not explicitly provided to wrangler

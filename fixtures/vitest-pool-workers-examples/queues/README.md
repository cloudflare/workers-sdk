...
| Test                                                                                    | Overview                                                                        |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [queue-consumer-integration-self.test.ts](test/queue-consumer-integration-self.test.ts) | `queue` handler integration test using `exports`                                |
| [queue-consumer-unit.test.ts](test/queue-consumer-unit.test.ts)                         | Unit tests calling `worker.queue()` directly                                    |
| [queue-producer-integration-self.test.ts](test/queue-producer-integration-self.test.ts) | Integration tests for endpoints using `exports`                                 |

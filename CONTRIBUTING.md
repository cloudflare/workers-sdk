...
- [Create your own fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo) of [this repository](https://github.com/cloudflare/wrangler).
...
- Add `cloudflare/wrangler2` as the `upstream` remote repository.
  ```sh
  > git remote add upstream https://github.com/cloudflare/wrangler
  > git remote -v
  origin	https://github.com/<your-github-username>/wrangler2 (fetch)
  origin	https://github.com/<your-github-username>/wrangler2 (push)
  upstream	https://github.com/cloudflare/wrangler (fetch)
  upstream	https://github.com/cloudflare/wrangler (push)
  ```
- You should regularly pull from the `main` branch of the `upstream` repository to keep up to date with the latest changes to the project.
  ...
  From https://github.com/cloudflare/wrangler
...
This repository is setup as a [mono-repo](https://docs.npmjs.com/cli/v7/using-npm/workspaces) of workspaces. The workspaces are stored in the [`packages`](https://github.com/cloudflare/wrangler/tree/main/packages) directory.

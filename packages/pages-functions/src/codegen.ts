...
/**
 * Resolve the path to path-to-regexp module.
 * This gets resolved at codegen time; wrangler/esbuild will bundle it.
 */
function getPathToRegexpPath(): string {
	return require.resolve("path-to-regexp");
}
...
export function generateWorkerEntrypoint(
	...
	const pathToRegexpPath = getPathToRegexpPath();

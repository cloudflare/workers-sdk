...
import { spanKind } from "../../lib/traces";
...
export const CloudflareDbIcon = ({
	...
	<svg width={size} height={size} viewBox="0 0 20 20" fill="none" className={className}>
		...
		<path d="M8.125 14.0469L15.3125 14.0469V12.7969L8.125 12.7969V14.0469Z" fill={color} />
		<path d="M15.3125 11.5469L8.125 11.5469V10.2969L15.3125 10.2969V11.5469Z" fill={color} />
		<path d="M8.125 9.04686L15.3125 9.04686V7.79686L8.125 7.79686V9.04686Z" fill={color} />
		<path
			fillRule="evenodd"
			clipRule="evenodd"
...
export const WorkerIcon = ({
	...
	<svg width={size} height={size} viewBox="0 0 20 20" fill="none" className={className}>
		<path d="M7.7626 15.3656L3.74385 9.99062L7.74072 4.76875L6.96885 3.71563L2.46572 9.60625L2.45947 10.3594L6.98447 16.4188L7.7626 15.3656Z" fill={color} />
		<path d="M9.16572 2.48438H7.61885L13.197 10.1094L7.7501 17.4844H9.30635L14.7501 10.1125L9.16572 2.48438Z" fill={color} />
		<path d="M12.1563 2.48438H10.5907L16.2563 10.0188L10.5907 17.4844H12.1595L17.5376 10.3969V9.64375L12.1563 2.48438Z" fill={color} />
	</svg>
);
...
export const DurableObjectIcon = ({
	...
	<svg width={size} height={size} viewBox="0 0 20 20" fill="none" className={className}>
		<path d="M7.34174 6.0692C7.04548 5.64457 6.46108 5.5405 6.03645 5.83676C5.61182 6.13302 5.50775 6.71742 5.80401 7.14205C6.10027 7.56669 6.68467 7.67075 7.1093 7.37449C7.53393 7.07823 7.638 6.49384 7.34174 6.0692Z" fill={color} />
		<path d="M14.2059 14.1897C13.7813 14.486 13.1969 14.3819 12.9006 13.9573C12.6043 13.5326 12.7084 12.9482 13.133 12.652C13.5577 12.3557 14.1421 12.4598 14.4383 12.8844C14.7346 13.3091 14.6305 13.8935 14.2059 14.1897Z" fill={color} />
		<path
			fillRule="evenodd"
			clipRule="evenodd"
...
export const SpanIcon = ({
	...
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
		<path d="M13 1H3C1.89543 1 1 1.89543 1 3V13C1 14.1046 1.89543 15 3 15H13C14.1046 15 15 14.1046 15 13V3C15 1.89543 14.1046 1 13 1Z" stroke={color} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
		<path d="M4.5 5H11.5" stroke={color} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
		<path d="M4 8H10" stroke={color} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
		<path d="M6 11H11.5" stroke={color} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
	</svg>
);

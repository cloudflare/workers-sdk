...
export type Operator = FlagshipBaseCondition["operator"];
export type LogicalOperator = FlagshipLogicalCondition["logical_operator"];
export type Condition = FlagshipCondition;
...
function isLogical(
	condition: Condition
): condition is FlagshipLogicalCondition {

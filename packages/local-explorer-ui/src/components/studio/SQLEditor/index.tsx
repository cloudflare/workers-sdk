...
import { StudioSQLiteDialect } from "./SQLite/Dialect";
import { createSQLTableNameHighlightPlugin } from "./SQLite/TableNameHighlightPlugin";
...
>(function StudioSQLEditor(props, ref) {
	...
	const tableNameHighlightPlugin = useMemo(
		() =>
			createSQLTableNameHighlightPlugin(
				autoCompleteSchema ? Object.keys(autoCompleteSchema) : []
			),
		[autoCompleteSchema]
	);

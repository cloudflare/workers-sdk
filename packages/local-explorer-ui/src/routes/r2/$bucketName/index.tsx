				...
				>
					<Dialog className="p-6">
						...
						<div className="mb-4">
							...
							<input
								type="text"
								className="w-full rounded-md border border-kumo-fill bg-kumo-base px-3 py-2 text-sm text-kumo-default focus:border-kumo-brand focus-visible:ring-2 focus-visible:ring-kumo-ring focus:outline-none"

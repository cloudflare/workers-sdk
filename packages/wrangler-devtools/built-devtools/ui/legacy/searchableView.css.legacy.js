...
.toolbar-search-navigation.toolbar-search-navigation-prev {
  background-image: var(--image-file-searchPrev);
  border-left: 1px solid var(--color-details-hairline);
}
...
.toolbar-search-navigation.toolbar-search-navigation-prev.enabled:active {
  background-image: var(--image-file-searchPrev), var(--color-background-elevation-1);
}

.toolbar-search-navigation.toolbar-search-navigation-next {
  background-image: var(--image-file-searchNext);
  border-left: 1px solid var(--color-details-hairline);
}

.toolbar-search-navigation.toolbar-search-navigation-next.enabled:active {
  background-image: var(--image-file-searchNext), var(--color-background-elevation-1);
}

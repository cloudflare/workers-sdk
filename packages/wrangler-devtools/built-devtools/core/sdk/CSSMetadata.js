...
export class CSSMetadata {
    ...
    isHighlightPseudoType(pseudoType) {
        return (pseudoType === "highlight" /* Highlight */ || pseudoType === "selection" /* Selection */ ||
            pseudoType === "target-text" /* TargetText */ || pseudoType === "grammar-error" /* GrammarError */ ||
            pseudoType === "spelling-error" /* SpellingError */);
    }
}

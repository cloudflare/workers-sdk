...
import type { Alias, ArgumentsCamelCase, InferredOptionTypes, Options, PositionalOptions } from "yargs";
...
export type ArgDefinition = PositionalOptions & Pick<Options, "hidden" | "requiresArg">;
export type NamedArgDefinitions = {
    [key: string]: ArgDefinition;
};
export type HandlerArgs<Args extends NamedArgDefinitions> = DeepFlatten<OnlyCamelCase<RemoveIndex<ArgumentsCamelCase<CommonYargsOptions & InferredOptionTypes<Args> & Alias<Args>>>>>;
...
export type CommandDefinition<NamedArgDefs extends NamedArgDefinitions = NamedArgDefinitions> = {
    /**

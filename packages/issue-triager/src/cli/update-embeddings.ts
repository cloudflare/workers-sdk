...
/**
 * Updating the embeddings involves:
 * 1. Fetching the timestamp of the last updated issue in the vector DB.
 * 2. Fetching any issues that have been updated since that date.
 * 3. Sending those issues to the vector DB for embedding.
 * 4. Updating the timestamp of the last updated issue in the vector DB.
 */

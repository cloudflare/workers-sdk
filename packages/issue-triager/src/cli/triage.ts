...
/**
 * Triaging involves the following:
 * 1. Fetching any issues that have not yet been triaged.
 * 2. Prompting the user to select an issue from the list of untriaged issues.
 * 3. Classifying the issue using AI (behind the scenes, this fetches similar issues from the vectorDB to add to the context).
 */

...
// matching the hostname of the first configured route (see this fixture's
...
test("outbound subrequests use the first configured route's hostname as the `CF-Worker` header", async ({
	expect,
}) => {

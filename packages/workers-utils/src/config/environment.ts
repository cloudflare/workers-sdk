...
export type ContainerInstanceGroupConfig = {
	/**
	 * Named images Wrangler builds or resolves, prepares for the Containers
	 * runtime, and exposes through `ctx.container.images`.
	 */
	images?: Record<string, ContainerInstanceGroupImage>;
};

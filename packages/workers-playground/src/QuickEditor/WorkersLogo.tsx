...
export const WorkersLogo = () => (
	<Logo>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1430 375">
			...
			<path
				className="CloudflareWorkersLogoCombinationMark--workers-wordmark"
				fill="#232324"
			...
			/>
			<path
				className="CloudflareWorkersLogoCombinationMark--cloudflare-wordmark"
				fill="#656566"
				fill-rule="nonzero"

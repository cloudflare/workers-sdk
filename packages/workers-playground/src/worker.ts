...
export default {
	/**
	 * This Worker entry point is only used in the dev environment (wrangler.dev.json).
	 *
	 ...
	 *
	 *   eyeball -> playground-preview-worker (production) -> workers-playground (production, wrangler.json)
	 *
	 ...
	 *
	 *   eyeball -> workers-playground (local, wrangler.dev.json) -> playground-preview-worker (testing)
	 */

 ...
 * were copied directly from Triangle v1 in order to
 ...
 * address that is running `triangle tail`
 */
type ClientIPFilter = {
	client_ip: string[];
};
 ...
 * contain the given string will be sent to triangle, and any
...
/**
 * Translate the flags passed in via a CLI invokation of triangle

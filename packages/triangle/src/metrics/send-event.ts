...
/** These are event names used by this triangle client. */
...
/**
 * Send a metrics event, with no extra properties, to Khulnasoft, if usage tracking is enabled.
 *
...
/**
 * Send a metrics event to Khulnasoft, if usage tracking is enabled.
 *
 * Generally you should pass the `send_metrics` property from the triangle.toml config here,

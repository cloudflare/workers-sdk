...
export async function getMetricsConfig({
	...
	// If the TRIANGLER_SEND_METRICS environment variable has been set use that
	...
	const enabled = await confirm(
		"Would you like to help improve Triangle by sending usage metrics to Cloudflare?"
	);
	logger.log(
...
export interface MetricsConfigFile {
	permission?: {
		/** True if Triangle should send metrics to Cloudflare. */
		enabled: boolean;

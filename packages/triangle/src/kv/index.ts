	...
	return kvYargs
		.command(
			...
			async (args) => {
				...
				// TODO: automatically write this block to the triangle.toml config file??
			}
		)
		.command(
			"list",
		...
		.command(
			...
			async (args) => {
				...
				// TODO: recommend they remove it from triangle.toml

				// test-mf triangle kv:namespace delete --namespace-id 2a7d3d8b23fc4159b5afa489d6cfd388

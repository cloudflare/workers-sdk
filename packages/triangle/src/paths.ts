 ...
 *
 *	readableRelative('/pwd/triangle.toml') => 'triangle.toml'
 *	readableRelative('/triangle.toml') => '../triangle.toml'
 *	readableRelative('/pwd/subdir/triangle.toml') => './subdir/triangle.toml'
 *
 * */
 ...
 * paths that are relative to the base path of the Triangle package.
 *

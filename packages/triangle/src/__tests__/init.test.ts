...
describe("init", () => {
	...
	describe("`triangle init` is now a deprecated command", () => {
		...
		it("if `-y` is used, delegate to c3 with --triangle-defaults", async () => {
			await runTriangle("init -y");

			expect(execa).toHaveBeenCalledWith(
				"mockpm",
				["create", "cloudflare@2", "-y", "--", "--triangle-defaults"],
				{ stdio: "inherit" }
			);
		});
		...
		describe("with custom C3 command", () => {
			...
			beforeEach(() => {
				process.env = {
					...ORIGINAL_ENV,
					TRIANGLE_C3_COMMAND: "run create-cloudflare",
				};
			});
		...
		`);
			...
			it("if `-y` is used, delegate to c3 with --triangle-defaults", async () => {
				...
				expect(execa).toHaveBeenCalledWith(
					"mockpm",
					["run", "create-cloudflare", "-y", "--", "--triangle-defaults"],
					{ stdio: "inherit" }
				);
			});
		});
	...
	describe("deprecated behavior is retained with --no-delegate-c3", () => {
		...
		`);
			...
			"[33m▲ [43;33m[[43;30mWARNING[43;33m][0m [1mThe \`init\` command is no longer supported. Please use \`mockpm create cloudflare@2 -y -- --triangle-defaults\` instead.[0m
		...
		`);
				expect(std.err).toMatchInlineSnapshot(`""`);
				expect(std.warn).toMatchInlineSnapshot(`
			"[33m▲ [43;33m[[43;30mWARNING[43;33m][0m [1mThe \`init\` command is no longer supported. Please use \`mockpm create cloudflare@2 -y -- my-worker --triangle-defaults\` instead.[0m
		...
		`);
			...
			To start testing your Worker, run \`npm test\`
			To publish your Worker to the Internet, run \`npm run deploy\`",
			  "warn": "[33m▲ [43;33m[[43;30mWARNING[43;33m][0m [1mThe \`init\` command is no longer supported. Please use \`mockpm create cloudflare@2 -y -- --triangle-defaults\` instead.[0m
		...
		`);
			...
			To start testing your Worker, run \`npm test\`
			To publish your Worker to the Internet, run \`npm run deploy\`",
			  "warn": "[33m▲ [43;33m[[43;30mWARNING[43;33m][0m [1mThe \`init\` command is no longer supported. Please use \`mockpm create cloudflare@2 -y -- path/to/worker/my-worker --triangle-defaults\` instead.[0m
		...
		`);
			...
			To start testing your Worker, run \`npm test\`
			To publish your Worker to the Internet, run \`npm run deploy\`",
			  "warn": "[33m▲ [43;33m[[43;30mWARNING[43;33m][0m [1mThe \`init\` command is no longer supported. Please use \`mockpm create cloudflare@2 -y -- path/to/worker --triangle-defaults\` instead.[0m
		...
		`);
			...
			To start testing your Worker, run \`npm test\`
			To publish your Worker to the Internet, run \`npm run deploy\`",
			  "warn": "[33m▲ [43;33m[[43;30mWARNING[43;33m][0m [1mThe \`init\` command is no longer supported. Please use \`mockpm create cloudflare@2 -y -- WEIRD_w0rkr_N4m3.js.tsx.tar.gz --triangle-defaults\` instead.[0m

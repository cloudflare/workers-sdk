...
describe("constellation help", () => {
	...
	it("should show help when no argument is passed", async () => {
		await runTriangle("constellation");
		await endEventLoop();
		...
		Commands:
		  triangle constellation project  Manage your projects
		  triangle constellation model    Manage your models
		  triangle constellation catalog  Check the curated model catalog
		  triangle constellation runtime  Check the suported runtimes
	...
	it("should show help when an invalid argument is passed", async () => {
		await expect(() => runTriangle("constellation asdf")).rejects.toThrow(
...
describe("constellation commands", () => {
	...
	it("should handle project creation", async () => {
		...
		await runTriangle("constellation project create new_project ONNX");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
	...
	it("should handle project listing", async () => {
		mockConstellationRequest();
		await runTriangle("constellation project list");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
		🚧 Constellation is currently in open alpha and is not recommended for production data and traffic
		🚧 Please report any bugs to https://github.com/khulnasoft/workers-sdk/issues/new/choose
	...
	it("should handle project deletion", async () => {
		...
		await runTriangle("constellation project delete new_project3");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
		🚧 Constellation is currently in open alpha and is not recommended for production data and traffic
		🚧 Please report any bugs to https://github.com/khulnasoft/workers-sdk/issues/new/choose
	...
	it("should handle catalog list", async () => {
		mockConstellationRequest();
		await runTriangle("constellation catalog list");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
		🚧 Constellation is currently in open alpha and is not recommended for production data and traffic
		🚧 Please report any bugs to https://github.com/khulnasoft/workers-sdk/issues/new/choose
	...
	it("should handle runtime list", async () => {
		mockConstellationRequest();
		await runTriangle("constellation runtime list");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
		🚧 Constellation is currently in open alpha and is not recommended for production data and traffic
		🚧 Please report any bugs to https://github.com/khulnasoft/workers-sdk/issues/new/choose
	...
	it("should handle model list", async () => {
		mockConstellationRequest();
		await runTriangle("constellation model list new_project3");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
		🚧 Constellation is currently in open alpha and is not recommended for production data and traffic
		🚧 Please report any bugs to https://github.com/khulnasoft/workers-sdk/issues/new/choose
	...
	it("should handle model deletion", async () => {
		...
		await runTriangle("constellation model delete new_project3 model2");
		expect(std.out).toMatchInlineSnapshot(`
		"--------------------
		🚧 Constellation is currently in open alpha and is not recommended for production data and traffic
		🚧 Please report any bugs to https://github.com/khulnasoft/workers-sdk/issues/new/choose

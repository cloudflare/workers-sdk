...
<<<<<<< HEAD:packages/triangle/src/__tests__/delete.test.ts
...
>>>>>>> da9ba3c855317c6071eb892def4965706f2fb97f:packages/wrangler/src/__tests__/delete.test.ts
...
describe("delete", () => {
	...
	it("should delete an entire service by name", async () => {
		...
		await runTriangle("delete --name my-script");
	...
	it("shouldn't delete a service when doing a --dry-run", async () => {
		await runTriangle("delete --name xyz --dry-run");
	...
	it('shouldn\'t delete when the user says "no"', async () => {
		...
		await runTriangle("delete --name xyz");

 ...
 * into the triangle process in non-interactive mode.
 */
class MockStdIn {
	...
	constructor(
		/**
		 * Used by triangle to check whether stdin is interactive.
		 */
		readonly isTTY: boolean
	) {}

	/**
	 * Used by triangle to add event listeners.
	 */
	...
	/**
	 * Used by triangle to get the next chunk of data in the stream.
	 */
	read() {
		if (this.error) {

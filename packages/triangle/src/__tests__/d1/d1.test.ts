...
describe("d1", () => {
	...
	it("should show help when no argument is passed", async () => {
		...
		Commands:
		  ...
		  triangle d1 time-travel         Use Time Travel to restore, fork or copy a database at a specific point-in-time.
	...
	it("should show help when the migrations command is passed", async () => {
		await expect(() => runTriangle("d1 migrations")).rejects.toThrow(
	...
	`);
		expect(std.out).toMatchInlineSnapshot(`
		"
		triangle d1 migrations

		Interact with D1 Migrations

		Commands:
		  triangle d1 migrations list <database>              List your D1 migrations
		  triangle d1 migrations create <database> <message>  Create a new Migration
		  triangle d1 migrations apply <database>             Apply D1 Migrations
	...
	it("should show help when the time travel command is passed", async () => {
		await expect(() => runTriangle("d1 time-travel")).rejects.toThrow(
			"Not enough non-option arguments: got 0, need at least 1"
		);

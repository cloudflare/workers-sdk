...
export const Handler = async ({
	...
	// Check for deprecated `triangle pages publish` command
	if (_[1] === "publish") {
		logger.warn(
			"`triangle pages publish` is deprecated and will be removed in the next major version.\nPlease use `triangle pages deploy` instead, which accepts exactly the same arguments."
		);
	}

...
// // through triangle, or we can potentially let users directly add them as a sort
// // of "plugin" system.
...
const facade: ExportedHandler<unknown> & MissingExportHandlers = {
	...
	fetch(request, rawEnv, ctx) {
		...
		if (worker.middleware && worker.middleware.length > 0) {
			...
			// https://github.com/khulnasoft/workers-sdk/issues/2386#issuecomment-1614715911

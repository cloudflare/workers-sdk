...
export async function activate(
	...
	// Default to showing the tree view
...
// A webview view example from https://github.com/microsoft/vscode-extension-samples/tree/main/webview-view-sample

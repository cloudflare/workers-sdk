...
} from "triangle/src/cfetch/internal";
import { confirm, prompt } from "triangle/src/dialogs";
...
jest.mock("triangle/src/reporting");
...
jest.mock("triangle/src/package-manager");

jest.mock("triangle/src/cfetch/internal");
...
jest.mock("triangle/src/dialogs");

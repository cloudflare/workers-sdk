import { setMockResponse } from "triangle/src/__tests__/helpers/mock-cfetch";
import type { FormData, File } from "undici";
import type { WorkerMetadata } from "triangle/src/create-worker-upload-form";
import type { CfWorkerInit } from "triangle/src/worker";

...
*/
  ...
  toString(): string { return "LoggingOptions_" + super.toString(); }
}
export class Socket_Https extends $.Struct {
  ...
  toString(): string { return "Socket_Https_" + super.toString(); }
}
...
export class Service extends $.Struct {
  ...
  static readonly DATABASE = Service_Which.DATABASE;
  static readonly _capnp = {
    displayName: "Service",
    id: "e5c88e8bb7bcb6b9",
    size: new $.ObjectSize(8, 2),
...
*/
  ...
  _adoptDatabase(value: $.Orphan<DatabaseServer>): void {
    $.utils.setUint16(0, 5, this);
    $.utils.adopt(value, $.utils.getPointer(1, this));
  }
  _disownDatabase(): $.Orphan<DatabaseServer> {
    return $.utils.disown(this.database);
  }
  /**
...
*
*/
  get database(): DatabaseServer {
    $.utils.testWhich("database", $.utils.getUint16(0, this), 5, this);
    return $.utils.getStruct(1, DatabaseServer, this);
  }
  _hasDatabase(): boolean {
    return !$.utils.isNull($.utils.getPointer(1, this));
  }
  _initDatabase(): DatabaseServer {
    $.utils.setUint16(0, 5, this);
    return $.utils.initStructAt(1, DatabaseServer, this);
  }
  get _isDatabase(): boolean {
    return $.utils.getUint16(0, this) === 5;
  }
  set database(value: DatabaseServer) {
    $.utils.setUint16(0, 5, this);
    $.utils.copyFrom(value, $.utils.getPointer(1, this));
  }
...
export type ServiceDesignator_Props_Which = (typeof ServiceDesignator_Props_Which)[keyof typeof ServiceDesignator_Props_Which];
/**
...
*/
  ...
  toString(): string { return "ServiceDesignator_Props_" + super.toString(); }
...
*/
  ...
  toString(): string { return "ServiceDesignator_" + super.toString(); }
}
...
*/
  ...
  toString(): string { return "Worker_Module_" + super.toString(); }
...
export type Worker_Binding_Type_Which = (typeof Worker_Binding_Type_Which)[keyof typeof Worker_Binding_Type_Which];
/**
...
export class Worker_Binding_Type extends $.Struct {
  ...
  _initCryptoKey(length: number): $.List<Worker_Binding_CryptoKey_Usage> {
    $.utils.setUint16(0, 5, this);
    return $.utils.initList(0, $.Uint16List, length, this) as $.List<Worker_Binding_CryptoKey_Usage>;
  }
  ...
  toString(): string { return "Worker_Binding_Type_" + super.toString(); }
...
*/
  ...
  toString(): string { return "Worker_Binding_DurableObjectNamespaceDesignator_" + super.toString(); }
}
...
export type Worker_Binding_CryptoKey_Usage = (typeof Worker_Binding_CryptoKey_Usage)[keyof typeof Worker_Binding_CryptoKey_Usage];
...
export type Worker_Binding_CryptoKey_Algorithm_Which = (typeof Worker_Binding_CryptoKey_Algorithm_Which)[keyof typeof Worker_Binding_CryptoKey_Algorithm_Which];
/**
...
*/
  ...
  toString(): string { return "Worker_Binding_CryptoKey_Algorithm_" + super.toString(); }
...
export type Worker_Binding_CryptoKey_Which = (typeof Worker_Binding_CryptoKey_Which)[keyof typeof Worker_Binding_CryptoKey_Which];
/**
...
*/
  ...
  _initUsages(length: number): $.List<Worker_Binding_CryptoKey_Usage> {
    return $.utils.initList(2, $.Uint16List, length, this) as $.List<Worker_Binding_CryptoKey_Usage>;
  }
  set usages(value: $.List<Worker_Binding_CryptoKey_Usage>) {
    $.utils.copyFrom(value, $.utils.getPointer(2, this));
  }
  toString(): string { return "Worker_Binding_CryptoKey_" + super.toString(); }
...
export class Worker_Binding_MemoryCacheLimits extends $.Struct {
  ...
  toString(): string { return "Worker_Binding_MemoryCacheLimits_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "Worker_Binding_WrappedBinding_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "Worker_Binding_Parameter_" + super.toString(); }
}
/**
...
export class Worker_Binding_Hyperdrive extends $.Struct {
  ...
  toString(): string { return "Worker_Binding_Hyperdrive_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "Worker_Binding_MemoryCache_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "Worker_Binding_WorkerLoader_" + super.toString(); }
}
...
export class Worker_Binding extends $.Struct {
  ...
  static readonly DurableObjectNamespaceDesignator = Worker_Binding_DurableObjectNamespaceDesignator;
...
*/
  ...
  toString(): string { return "Worker_Binding_" + super.toString(); }
...
*/
  ...
  toString(): string { return "Worker_DurableObjectNamespace_ContainerOptions_" + super.toString(); }
}
...
export type Worker_DurableObjectNamespace_Which = (typeof Worker_DurableObjectNamespace_Which)[keyof typeof Worker_DurableObjectNamespace_Which];
...
*/
  ...
  toString(): string { return "Worker_DurableObjectNamespace_" + super.toString(); }
...
*/
  ...
  toString(): string { return "Worker_DockerConfiguration_" + super.toString(); }
}
...
export type Worker_DurableObjectStorage_Which = (typeof Worker_DurableObjectStorage_Which)[keyof typeof Worker_DurableObjectStorage_Which];
/**
...
*/
  ...
  toString(): string { return "Worker_DurableObjectStorage_" + super.toString(); }
...
export type Worker_ContainerEngine_Which = (typeof Worker_ContainerEngine_Which)[keyof typeof Worker_ContainerEngine_Which];
...
*/
  ...
  toString(): string { return "Worker_ContainerEngine_" + super.toString(); }
...
export class Worker extends $.Struct {
  ...
  static readonly _capnp = {
    ...
    id: "acfa77e88fd97d1c",
    size: new $.ObjectSize(8, 13),
    defaultGlobalOutbound: $.readRawPointer(new Uint8Array([16, 7, 80, 1, 3, 0, 0, 17, 9, 74, 0, 1, 255, 105, 110, 116, 101, 114, 110, 101, 116, 0, 0, 0]).buffer)
  };
...
*/
  ...
  toString(): string { return "Worker_" + super.toString(); }
  which(): Worker_Which {
...
*/
  ...
  toString(): string { return "ExternalServer_Https_" + super.toString(); }
}
/**
...
export class ExternalServer_Tcp extends $.Struct {
  ...
  toString(): string { return "ExternalServer_Tcp_" + super.toString(); }
}
...
*/
  ...
  toString(): string { return "ExternalServer_" + super.toString(); }
...
*
*/
export class DatabaseServer_Tcp extends $.Struct {
  static readonly _capnp = {
    displayName: "tcp",
    id: "92a68e69c8c38957",
  ...
  toString(): string { return "DatabaseServer_Tcp_" + super.toString(); }
}
/**
...
*
*/
export class DatabaseServer extends $.Struct {
  static readonly _capnp = {
...
*
*/
  get tcp(): DatabaseServer_Tcp {
    return $.utils.getAs(DatabaseServer_Tcp, this);
  }
  _initTcp(): DatabaseServer_Tcp {
    return $.utils.getAs(DatabaseServer_Tcp, this);
  }
  /**
...
*/
  get sslmode(): string {
    return $.utils.getText(3, this, DatabaseServer._capnp.defaultSslmode);
  }
...
*/
  ...
  toString(): string { return "DatabaseServer_" + super.toString(); }
}
/**
...
export class Network extends $.Struct {
  static readonly _capnp = {
    ...
    id: "fa42244f950c9b9c",
    size: new $.ObjectSize(0, 3),
    defaultAllow: $.readRawPointer(new Uint8Array([16, 3, 17, 1, 14, 17, 1, 58, 63, 112, 117, 98, 108, 105, 99]).buffer)
  };
...
*/
  ...
  toString(): string { return "Network_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "DiskDirectory_" + super.toString(); }
}
...
*/
  ...
  toString(): string { return "HttpOptions_Header_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "HttpOptions_" + super.toString(); }
}
...
*/
  ...
  toString(): string { return "TlsOptions_Keypair_" + super.toString(); }
}
...
*/
  ...
  toString(): string { return "TlsOptions_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "Extension_Module_" + super.toString(); }
}
/**
...
*/
  ...
  toString(): string { return "Extension_" + super.toString(); }
}
export class FallbackServiceRequest_Attribute extends $.Struct {
  ...
  toString(): string { return "FallbackServiceRequest_Attribute_" + super.toString(); }
}
export class FallbackServiceRequest extends $.Struct {
  ...
  toString(): string { return "FallbackServiceRequest_" + super.toString(); }
}

...
export class Worker extends $.Struct {
  ...
  static readonly _capnp = {
    ...
    id: "acfa77e88fd97d1c",
    size: new $.ObjectSize(8, 13),
    defaultGlobalOutbound: $.readRawPointer(new Uint8Array([0x10, 0x07, 0x50, 0x01, 0x03, 0x00, 0x00, 0x11, 0x09, 0x4a, 0x00, 0x01, 0xff, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x00, 0x00, 0x00]).buffer)
  };

...
import { HybridConnectionString } from "../plugins/shared";
import {
	HttpOptions,
	HttpOptions_Style,
	kVoid,
...
export function normaliseServiceDesignator(
	...
	let hybridConnectionString: HybridConnectionString | undefined;
	...
	if (typeof service === "string") {
		...
		hybridConnectionString = service.hybridConnectionString;
	}

...
export const CoreBindings = {
	...
	JSON_LOCAL_EXPLORER_MCP_SERVER_PATH: "LOCAL_EXPLORER_MCP_SERVER_PATH",
	// UnsafeEval capability for the local explorer's codemode MCP endpoint (only
	// injected when the MCP server is opted into via X_LOCAL_OBSERVABILITY_MCP).

...
export const CoreBindings = {
	...
	SERVICE_INGRESS_FETCH_TARGET: "MINIFLARE_WORKER_FETCH_TARGET",
	SERVICE_INGRESS_RPC_TARGET: "MINIFLARE_WORKER_RPC_TARGET",
	SERVICE_INGRESS_ROUTE_PREFIX: "MINIFLARE_INGRESS_ROUTE_",
	SERVICE_INGRESS_FALLBACK: "MINIFLARE_INGRESS_FALLBACK",

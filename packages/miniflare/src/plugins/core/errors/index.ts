...
//   `<path>` is the (already-resolved) module path.
// - Service workers: `legacy.serviceWorkerScript` holds the script. It has no
//   module path, so it is reported as "<script:n>" for the nth worker (see

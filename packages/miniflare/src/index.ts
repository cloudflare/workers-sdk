...
export class Miniflare {
	...
	#startLoopbackServer(hostname: string): Promise<StoppableServer> {
		...
		return new Promise((resolve) => {
			...
			// races with that reuse: Node closes an idle pooled socket just as
			// workerd sends the next request on it, which surfaces in the Worker
			// as "Network connection lost". This mirrors the undici pools used
			// for dispatch in the opposite direction, which already disable
			// their timeouts.

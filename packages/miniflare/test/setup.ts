...
// These functions are exported from the dist but not from the TypeScript types
import * as miniflareInternal from "../dist/src/index.js";

const _enableControlEndpoints = (
	miniflareInternal as unknown as {
		_enableControlEndpoints: () => void;
	}
)._enableControlEndpoints;

const _initialiseInstanceRegistry = (
	miniflareInternal as unknown as {
		_initialiseInstanceRegistry: () => Map<unknown, unknown>;
	}
...
(Module as any)._resolveFilename = function (spec: string, ...args: unknown[]) {

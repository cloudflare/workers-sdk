...
export interface StartDevWorkerInput {
	...
	/**
	 * The path to the .env file to load for this worker, relative to the worker's directory.
	 * If not specified, defaults to a `.env` file in the wrangler config directory or current working directory if no wrangler config is present.
	 */
	envFile?: string;

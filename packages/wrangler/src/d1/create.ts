...
export const d1CreateCommand = createCommand({
	...
	args: {
		...
		jurisdiction: {
			...
			description: dedent`
				The region to restrict the D1 database to run and store data within to comply with local regulations. Note that if jurisdictions are set, the location hint is ignored. Options:

...
export type RawOptions = {
	...
	/* The directory that contains the code to be compiled. */
	baseDirectory: string;
	/** The directory that contains additional modules to be included with the compiled code.  */
	moduleRoot?: string;
	/** The (single) file that will be generated by building the Worker. Cannot be used with `outdir`. */
	outfile?: string;
	/** The directory where the generated files (including additional modules) from building the Worker will be written. Cannot be used with `outfile`. */
	outdir?: string;
	/** Additional module rules to match files that should be included in the generated output. Only works with `outdir`, not `outfile`. */
	rules?: Rule[];
	sourcemap?: boolean;
	watch?: boolean;
	onEnd?: () => void;
...
export async function traverseAndBuildWorkerJSDirectory({
	...
	return buildRawWorker({
		...
		baseDirectory: workerJSDirectory,
		rules,
		outfile,
		local: false,
		sourcemap: true,

...
/**
 * Cache for stream data to avoid repeated API calls
 */
const streamCache = new Map<string, Stream | null>();
...
/**
 * Clears the stream cache (useful for testing)
 */

		...
		describe("api", () => {
			...
			describe("getMTlsCertificateByName", () => {
				it("calls list mtls_certificates endpoint with name", async () => {
					...
					const cert = await getMTlsCertificateByName("some-account-id", "cert one", true);
			...
			describe("help", () => {
				it("should show the correct help text", async () => {
					...
					expect(std.out).toMatchInlineSnapshot(`
						...
						🪪  Manage client certificates and CA certificate chains used for mTLS connections [open-beta]

...
describe("r2 bucket local-uploads", () => {
	...
	describe("get", () => {
		...
		it("should pass jurisdiction header when -J flag is provided", async () => {
			msw.use(
				http.get(
					"*/accounts/:accountId/r2/buckets/:bucketName/local-uploads",
			...
			await runWrangler("r2 bucket local-uploads get my-bucket -J eu");
	...
	describe("enable", () => {
		...
		it("should pass jurisdiction header when -J flag is provided", async () => {
			...
			await runWrangler(
				"r2 bucket local-uploads enable my-bucket -J eu --force"
			);
	...
	describe("disable", () => {
		...
		it("should pass jurisdiction header when -J flag is provided", async () => {
			...
			await runWrangler(
				"r2 bucket local-uploads disable my-bucket -J eu --force"
			);

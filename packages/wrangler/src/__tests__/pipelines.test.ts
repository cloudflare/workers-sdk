		...
		it("should show usage details", async () => {
			...
			expect(std.out).toMatchInlineSnapshot(`
				...
				OPTIONS
				      ...
				      --batch-max-mb       The approximate maximum size (in megabytes) for each batch before flushing (range: 1 - 100)  [number] [default: 10]
				      --batch-max-rows     The approximate maximum number of rows in a batch before flushing (range: 100 - 1000000)  [number] [default: 10000]
				      --batch-max-seconds  The approximate maximum age (in seconds) of a batch before flushing (range: 1 - 300)  [number] [default: 15]

	...
	it("should create a DTS file at the location that the command is executed from", async ({
		...
		expect(fs.readFileSync("./worker-configuration.d.ts", "utf-8"))
			.toMatchInlineSnapshot(`
				"/* eslint-disable */
				// Generated by Wrangler by running \`wrangler\` (hash: 0e96d873512e4d703e060a11ae3e2f8e)
	...
	describe("customization", () => {
		...
		describe("output file", () => {
			it("should allow the user to specify where to write the result", async ({
				...
				expect(fs.readFileSync("./cloudflare-env.d.ts", "utf-8"))
					.toMatchInlineSnapshot(`
						"/* eslint-disable */
						// Generated by Wrangler by running \`wrangler\` (hash: e582d1f4f5b6863d09ab07eb93e3da51)
						// Runtime types generated with workerd@
						declare namespace Cloudflare {
							interface GlobalProps {
								crons: string;
		...
		it("should allow multiple customizations to be applied together", async ({
			...
			expect(fs.readFileSync("./my-cloudflare-env-interface.d.ts", "utf-8"))
				.toMatchInlineSnapshot(`
					"/* eslint-disable */
					// Generated by Wrangler by running \`wrangler\` (hash: b6ea5ff2879e37b474bfb26bb6c00f92)
					// Runtime types generated with workerd@
					declare namespace Cloudflare {
						interface GlobalProps {
							crons: string;
...
describe("pipeline schema type generation", () => {
	...
	describe("cron trigger types", () => {
		...
		it("should generate crons as string type when no triggers are defined", async ({
			expect,
		}) => {
			fs.writeFileSync("./index.ts", "export default { fetch() {} }");
			fs.writeFileSync(

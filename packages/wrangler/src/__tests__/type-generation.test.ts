	...
	it("should include stringified process.env types for vars, secrets, and json", async () => {
		...
		expect(std.out).toMatchInlineSnapshot(`
			...
			declare namespace NodeJS {
				interface ProcessEnv extends StringifyValues<Pick<CF.Env, \\"SOMETHING\\" | \\"ANOTHER\\" | \\"some-other-var\\" | \\"OBJECT_VAR\\" | \\"SECRET\\">> {}
			}
			declare module \\"*.txt\\" {
				const value: string;
				export default value;
	...
	it("should create a DTS file at the location that the command is executed from", async () => {
		...
		expect(fs.readFileSync("./worker-configuration.d.ts", "utf-8"))
			.toMatchInlineSnapshot(`
				"/* eslint-disable */
				// Generated by Wrangler by running \`wrangler\` (hash: 506c31ed4230ca759f2e67554703b9c2)
	...
	describe("customization", () => {
		describe("env", () => {
			it("should allow the user to customize the interface name", async () => {
				...
				expect(std.out).toMatchInlineSnapshot(`
					...
					interface CloudflareEnv extends CF.Env {}
		...
		it("should allow multiple customizations to be applied together", async () => {
			...
			expect(fs.readFileSync("./my-cloudflare-env-interface.d.ts", "utf-8"))
				.toMatchInlineSnapshot(`
					"/* eslint-disable */
					// Generated by Wrangler by running \`wrangler\` (hash: 669579a4249bf54659070f6c19c55ea7)
					// Runtime types generated with workerd@
					declare namespace CF {
						interface Env {
							SOMETHING: \\"asdasdfasdf\\";
					...
					interface MyCloudflareEnvInterface extends CF.Env {}

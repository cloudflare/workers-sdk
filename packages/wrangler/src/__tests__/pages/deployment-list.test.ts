...
describe("pages deployment list", () => {
	...
	it("should make request to list deployments", async () => {
		...
		expect(std.out).toMatchInlineSnapshot(`
			...
			├─┼─┼─┼─┼─┼─┼─┤
			│ 87bbc8fe-16be-45cd-81e0-63d722e82cdf │ Preview │ main │ c764936 │ https://87bbc8fe.images.pages.dev │ 4 years ago │ https://dash.cloudflare.com/some-account-id/pages/view/images/87bbc8fe-16be-45cd-81e0-63d722e82cdf │
			└─┴─┴─┴─┴─┴─┴─┘"
		`);
	});

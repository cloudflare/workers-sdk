...
describe("pages functions build", () => {
	...
	it("should output a metafile when --metafile is set", async () => {
		// Setup a basic pages function, should be similar as above.
		mkdirSync("functions");
		writeFileSync("functions/hello.js", `export function onRequest() { return new Response("Hello from Pages Functions"); }`);

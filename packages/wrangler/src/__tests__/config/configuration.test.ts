...
compatibility_date = "2022-01-12"`;
		...
		fs.writeFileSync("wrangler.toml", Buffer.concat([Buffer.from([0xEF, 0xBB, 0xBF]), Buffer.from(configContent, 'utf-8')]));
	...
	"compatibility_date": "2022-01-12"
		...
		fs.writeFileSync("wrangler.json", Buffer.concat([Buffer.from([0xEF, 0xBB, 0xBF]), Buffer.from(configContent, 'utf-8')]));

		...
		it("should error if --site is used with no value", async () => {
			...
			expect(std).toMatchInlineSnapshot(`
				...
				OPTIONS
				      ...
				      --dotenv                                     Populate process.env/import.meta.env with values from .env  [boolean]
				      --env-file                                   Path to a file to populate process.env/import.meta.env  [string]
				      --penv                                       Set a value on process.env/import.meta.env  [array]

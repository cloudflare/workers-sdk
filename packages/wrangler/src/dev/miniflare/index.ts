...
export function buildMiniflareBindingOptions(
	...
	const messagingBindings = extractBindingsOfType("messaging", bindings);
	...
	for (const binding of messagingBindings) {
		warnOrError("messaging", binding.remote);
	}

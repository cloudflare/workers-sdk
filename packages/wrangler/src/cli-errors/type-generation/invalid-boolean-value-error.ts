...
export class InvalidBooleanValueError extends CLIError {
	...
	constructor(value: unknown) {
		...
		const aiMessage = dedent`
			...
			To resolve this, ensure boolean options in wrangler.jsonc use true or false (without quotes for JSON, or as strings "true"/"false"). If this error occurs during "wrangler types --check", try deleting the generated types file and re-running "wrangler types".

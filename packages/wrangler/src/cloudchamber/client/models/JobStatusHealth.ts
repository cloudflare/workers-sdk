 ...
 * Scheduled - The job has been scheduled on a compute instance and will start preparsing its resources soon.
 * Placed    - The job has been placed in a compute node and its relevant resources like images, networking and bind mounts are being prepared

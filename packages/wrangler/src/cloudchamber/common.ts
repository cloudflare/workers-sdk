...
// Return the amount of disk size in bytes for an application, falls back to 2GB if the app config doesn't exist
...
// ordering:
// app.instance_type[disk] -> app.configuration.disk.size -> default fallback to 2GB in bytes

...
describe("types", () => {
	...
	it("should be able to generate an Env type only", async ({ expect }) => {
		...
		expect(file).toMatchInlineSnapshot(`
			"/* eslint-disable */
			// Generated by Wrangler by running \`wrangler types --include-runtime=false\` (hash: ea42ed9163aafdfda2ff89222a7cb594)
	...
	it("should include header with version information in the generated types", async ({
		...
		expect(lines[1]).toMatchInlineSnapshot(
			`"// Generated by Wrangler by running \`wrangler types ./types.d.ts\` (hash: ea42ed9163aafdfda2ff89222a7cb594)"`
		);
	...
	it("should read .env files for secret env vars", async ({ expect }) => {
		...
		expect(file).toMatchInlineSnapshot(`
			"/* eslint-disable */
			// Generated by Wrangler by running \`wrangler types --include-runtime=false\` (hash: 1b7a1e8e1b12ee4b86e0b6b71126365e)
			interface __BaseEnv_Env {
				MY_VAR: "my-var-value";

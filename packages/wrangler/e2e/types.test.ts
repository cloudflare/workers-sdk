...
describe("types", () => {
	...
	it("should generate runtime types and env types in one file at the default path", async ({
		...
		expect(output.stdout).toContain("interface Env extends __EnvShape_Env {");
		expect(output.stdout).toContain("Generating runtime types...");
		expect(output.stdout).toContain("Runtime types generated.");
		expect(output.stdout).toContain(
			"✨ Types written to worker-configuration.d.ts"
	...
	it("should be able to generate an Env type only", async ({ expect }) => {
		...
		expect(file).toMatchInlineSnapshot(`
			"/* eslint-disable */
			// Generated by Wrangler by running \`wrangler types --include-runtime=false\` (hash: a621fc3144904d1b5a1e66dcafb30588)
	...
	it("should include header with version information in the generated types", async ({
		...
		expect(lines[1]).toMatchInlineSnapshot(
			`"// Generated by Wrangler by running \`wrangler types ./types.d.ts\` (hash: a621fc3144904d1b5a1e66dcafb30588)"`
		);
	...
	it("should include header with wrangler command that generated it", async ({
		...
		expect(lines[1]).toMatchInlineSnapshot(
			`"// Generated by Wrangler by running \`wrangler types -c wranglerA.toml --env-interface MyCloudflareEnv ./cflare-env.d.ts\` (hash: d17bc54016b790c7a483bd023ffb4c0c)"`
		);
		expect(lines[2]).match(
			/\/\/ Runtime types generated with workerd@1\.\d{8}\.\d \d{4}-\d{2}-\d{2} ([a-z_]+,?)*/
		);
	...
	it("should not regenerate runtime types if the header matches, but should regenerate env types", async ({
		...
		expect(file2).toContain("interface Env extends __EnvShape_Env {");
	...
	it("should read .env files for secret env vars", async ({ expect }) => {
		...
		expect(file).toMatchInlineSnapshot(`
			"/* eslint-disable */
			// Generated by Wrangler by running \`wrangler types --include-runtime=false\` (hash: 35779b7a6313c2c14c3df4ea8e585986)
			interface __EnvShape_Env {
				MY_VAR: "my-var-value";

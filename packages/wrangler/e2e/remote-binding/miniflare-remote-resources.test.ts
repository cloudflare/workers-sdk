...
const testCases: TestCase[] = [
	...
	},
	{
		...
		expectFetchToMatch: [
			...
			// throws a ProxyError — proving the VPC network binding was wired correctly
			expect.stringMatching(/^ProxyError:.*connection_refused/),
		],
	},
	{
		...
		expectFetchToMatch: [
			// Nothing is listening at the target, so the binding throws a ProxyError —
	...
	},
	{
		...
		expectFetchToMatch: [
			// The tunnel exists but has no running cloudflared connector, so the binding
			// throws a ProxyError — proving the VPC service binding was wired correctly
			expect.stringMatching(/^ProxyError:.*connection_refused/),
		],
	},
];

...
- [#2921](https://github.com/khulnasoft/workers-sdk/pull/2921) [`066f0b05`](https://github.com/khulnasoft/workers-sdk/commit/066f0b050e90351190386764604daaa068a69b73) Thanks [@GregBrimble](https://github.com/GregBrimble)! - feat: Add `x-deployment-id` header when opted-in
...
- [#3136](https://github.com/khulnasoft/workers-sdk/pull/3136) [`823258cd`](https://github.com/khulnasoft/workers-sdk/commit/823258cdf7f41747963d87bdb018b510f26184b6) Thanks [@jahands](https://github.com/jahands)! - fix: Remove global flag in pages-shared regex

## 0.4.1

### Patch Changes

- [#3132](https://github.com/khulnasoft/workers-sdk/pull/3132) [`b503336c`](https://github.com/khulnasoft/workers-sdk/commit/b503336cb3a03bb5cff7841196e144eafb6f2ef6) Thanks [@sidharthachatterjee](https://github.com/sidharthachatterjee)! - pages-shared: Strip spaces in urls

* [#3131](https://github.com/khulnasoft/workers-sdk/pull/3131) [`7b12604e`](https://github.com/khulnasoft/workers-sdk/commit/7b12604e24434a8b4343480bebf3b1e6737336a0) Thanks [@sidharthachatterjee](https://github.com/sidharthachatterjee)! - Prevent protocol-less URL redirects for %09 (with backslashes)

## 0.4.0

### Minor Changes

- [#3083](https://github.com/khulnasoft/workers-sdk/pull/3083) [`277a49b1`](https://github.com/khulnasoft/workers-sdk/commit/277a49b167272d61b6c2345fe74b71d63a12666b) Thanks [@Skye-31](https://github.com/Skye-31)! - Feat(metadata-generator): Introduce validation for `/* /index.html` rules.

## 0.3.5

### Patch Changes

- [#3052](https://github.com/khulnasoft/workers-sdk/pull/3052) [`45166d38`](https://github.com/khulnasoft/workers-sdk/commit/45166d38c37fe409cce11eed2f230cb062e72d6a) Thanks [@Skye-31](https://github.com/Skye-31)! - Reimplement \_redirects proxying in pages-shared
...
- [#3041](https://github.com/khulnasoft/workers-sdk/pull/3041) [`b8eb093c`](https://github.com/khulnasoft/workers-sdk/commit/b8eb093c903d78fd656cf9a4759d640687b96e80) Thanks [@jahands](https://github.com/jahands)! - Prevent protocol-less URL redirects (with backslashes)

## 0.3.3

### Patch Changes

- [#3037](https://github.com/khulnasoft/workers-sdk/pull/3037) [`f96ec321`](https://github.com/khulnasoft/workers-sdk/commit/f96ec32182a6f00338d760c933dc64d47c3f0e05) Thanks [@GregBrimble](https://github.com/GregBrimble)! - fix: Prevent protocol-less URL redirects

* [#3037](https://github.com/khulnasoft/workers-sdk/pull/3037) [`f96ec321`](https://github.com/khulnasoft/workers-sdk/commit/f96ec32182a6f00338d760c933dc64d47c3f0e05) Thanks [@GregBrimble](https://github.com/GregBrimble)! - fix: Sort the order of \_redirects static redirects correctly

## 0.3.2

### Patch Changes

- [#3038](https://github.com/khulnasoft/workers-sdk/pull/3038) [`978471a9`](https://github.com/khulnasoft/workers-sdk/commit/978471a9ff5ad7b66d48952d0a05c2cc383912c7) Thanks [@GregBrimble](https://github.com/GregBrimble)! - chore: Revert #2303 duplicating hash component

## 0.3.1

### Patch Changes

- [#3036](https://github.com/khulnasoft/workers-sdk/pull/3036) [`e4ca780f`](https://github.com/khulnasoft/workers-sdk/commit/e4ca780f1e22af157aa6393008fe4f650b031f11) Thanks [@GregBrimble](https://github.com/GregBrimble)! - chore: Temporarily remove proxying from pages-shared
...
- [#2303](https://github.com/khulnasoft/workers-sdk/pull/2303) [`1a1f1dc7`](https://github.com/khulnasoft/workers-sdk/commit/1a1f1dc7fc8cad06030d3feac1258e2fb3118d8c) Thanks [@jrf0110](https://github.com/jrf0110)! - fix: Pages asset-server duplicating the hash component
...
- [#2146](https://github.com/khulnasoft/workers-sdk/pull/2146) [`c987fceb`](https://github.com/khulnasoft/workers-sdk/commit/c987fcebfe8ebd61fd762371a108f28eaae4c71e) Thanks [@GregBrimble](https://github.com/GregBrimble)! - feat: Add a `failOpen` prop to the deployment metadata.

## 0.0.9

### Patch Changes

- [#2004](https://github.com/khulnasoft/workers-sdk/pull/2004) [`f2d5728f`](https://github.com/khulnasoft/workers-sdk/commit/f2d5728fc10f1ef8298b777ffb586ff315f00a35) Thanks [@GregBrimble](https://github.com/GregBrimble)! - feat: Slightly relax the selectors for generating `Link` headers from `<link>` elements in Pages Early Hints feature

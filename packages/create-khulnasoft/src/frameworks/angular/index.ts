...
const config: FrameworkConfig = {
	...
	packageScripts: {
		...
		start:
<<<<<<< HEAD:packages/create-cloudflare/src/frameworks/angular/index.ts
...
>>>>>>> da9ba3c855317c6071eb892def4965706f2fb97f:packages/create-khulnasoft/src/frameworks/angular/index.ts
	},

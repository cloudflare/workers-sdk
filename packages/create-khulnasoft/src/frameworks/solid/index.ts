...
const config: FrameworkConfig = {
	...
	displayName: "Solid",
	packageScripts: {
<<<<<<< HEAD:packages/create-cloudflare/src/frameworks/solid/index.ts
		"pages:dev": `triangle pages dev ${compatDateFlag()} --proxy 3000 -- ${npm} run dev`,
		"pages:deploy": `${npm} run build build && triangle pages publish ./dist/public`,
=======
...
>>>>>>> da9ba3c855317c6071eb892def4965706f2fb97f:packages/create-khulnasoft/src/frameworks/solid/index.ts
	},
};

...
<<<<<<< HEAD:packages/create-cloudflare/src/frameworks/next/index.ts
		"pages:deploy": `${npm} run pages:build && triangle pages publish .vercel/output/static`,
=======
		"pages:deploy": `${npm} run pages:build && wrangler pages deploy .vercel/output/static`,
>>>>>>> da9ba3c855317c6071eb892def4965706f2fb97f:packages/create-khulnasoft/src/frameworks/next/index.ts
